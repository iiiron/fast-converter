...
//
//    @Override
//    protected ConvertResult<Object> convertingAndVerify(Object value, String tip, Validator afterConvert) throws ConvertException {
...
//                if (converter != null) {
//                    ConvertResult verifyResult = converter.convertAndVerify(newV, tip);
...
//
//        if (stringBuilder.length() > 0) {
//            return new ConvertResult<>(newArray, stringBuilder.insert(0,"{").append("}").toString());
//        } else {
//            return new ConvertResult<>(newArray);
//        }
//    }
//
//    @Override
