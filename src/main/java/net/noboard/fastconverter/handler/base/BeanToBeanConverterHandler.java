...
//     */
//    @Override
//    protected ConvertResult<K> convertingAndVerify(T value, String tip, Validator afterConvert) throws ConvertException {
//        BeanInfo beanF, beanT;
//        Object objF = value, objT;
//        ConvertResult<K> verifyResult = new ConvertResult<>();
...
//                                    if ("".equals(ci.tip())) {
//                                        result = converter.convertAndVerify(afterConvertValue, validator);
//                                    } else {
//                                        result = converter.convertAndVerify(afterConvertValue, ci.tip(), validator);
//                                    }
//                                    afterConvertValue = result.getValue();
//                                    if (!result.isPass()) {
//                                        if (result.getFlag() == null) {
//                                            result.setFlag(tD.getName());
//                                        } else {
//                                            result.setFlag(tD.getName() + "." + result.getFlag());
//                                        }
...
//                            converter = this.getConverter(fieldOriginalValue);
//                            if (converter != null) {
//                                ConvertResult result;
//                                if (this.getClass().equals(converter.getClass())) {
//                                    // 这里是为了赋予BeanToBeanConverter自动转换Bean内部的Bean
//                                    result = converter.convertAndVerify(fieldOriginalValue, tD.getPropertyType().getName());
//                                } else {
//                                    result = converter.convertAndVerify(fieldOriginalValue);
//                                }
//
//                                afterConvertValue = result.getValue();
//                                if (!result.isPass()) {
...
//            return new ConvertResult<>((K) objT, stringBuilder.insert(0, "{").append("}").toString());
//        } else {
//            return new ConvertResult<>((K) objT);
//        }
//    }
//
