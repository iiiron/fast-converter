...
//    }
//
//    protected ConvertResult handlerAndVerify(ConverterIndicator annotation, Object fieldValue) {
...
//            return new ConvertResult(value, verifyInfo.getErrCode(), verifyInfo.getErrMessage());
//        } else {
