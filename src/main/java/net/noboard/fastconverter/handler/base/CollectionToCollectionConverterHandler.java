...
//
//    @Override
//    protected ConvertResult<Collection<K>> convertingAndVerify(Collection<T> value, String tip, Validator afterConvert) throws ConvertException {
...
//
//        if (stringBuilder.length() > 0) {
//            return new ConvertResult<>(collection, stringBuilder.insert(0,"{").append("}").toString());
//        } else {
//            return new ConvertResult<>(collection);
//        }
//    }
//
//    @Override
