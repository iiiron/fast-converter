...
//
//    @Override
//    protected ConvertResult<Map<String, Object>> convertingAndVerify(Object value, String tip, Validator afterConvert) throws ConvertException {
...
//                    ConvertResult verifyResult = converter.convertAndVerify(fieldValue);
...
//                    ConvertResult verifyResult = this.handlerAndVerify(annotation, v);
